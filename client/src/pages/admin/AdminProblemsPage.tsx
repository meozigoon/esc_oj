...
export default function AdminProblemsPage() {
    ...
    const handleCreate = async () => {
        ...
        const useGeneratedTests =
            submissionType === "CODE" && judgeMode === "GENERATED";
        ...
        try {
            await apiFetch("/api/admin/problems", {
                ...
                body: JSON.stringify({
                    ...
                    generatorLanguage:
                        useGeneratedTests && generatorLanguage !== ""
                            ? generatorLanguage
                            : null,
                    generatorCode: useGeneratedTests ? generatorCode : "",
                    solutionLanguage:
                        useGeneratedTests && solutionLanguage !== ""
                            ? solutionLanguage
                            : null,
            ...
            >
                <CardContent>
                    <Stack spacing={2}>
                        ...
                        {submissionType === "CODE" && (
                            <FormControl>
                                <InputLabel id="judge-mode-label">
                                    채점 방식
                                </InputLabel>
                                <Select
                                ...
                                {judgeMode === "GENERATED" ? (
                                    <>
                                        ...
                                        <Typography
                                            ...
                                            color="text.secondary"
                                        >
                                            생성 코드와 정답 코드가 모두 입력된
                                            경우 생성된 테스트케이스로
                                            채점합니다.
                                        </Typography>
                                        <FormControl>
                                            <InputLabel id="solution-language-label">
                                                정답 언어
                                            </InputLabel>
                                            <Select
                                    ...
                                    <Typography
                                        ...
                                        color="text.secondary"
                                    >
                                        테스트케이스로 채점합니다. 생성 후 문제
                                        편집 화면에서 테스트케이스를 추가하세요.
                                    </Typography>
                                )}
                            </>
                        )}
